          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            ...
            <div className="md:col-span-5 project-card">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-white text-lg">Manuguru, Telangana</p>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a 
                    href="https://github.com/Pavankumar098" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-portfolio-dark-blue hover:bg-portfolio-blue transition-colors p-2 rounded-full"
                  >
                    <Github size={24} />
                  </a>
                  <a 
                    href="https://www.linkedin.com/in/pavan-kumar-057285222/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="bg-portfolio-dark-blue hover:bg-portfolio-blue transition-colors p-2 rounded-full"
                  >
                  ...
                  <a 
                    href="mailto:pavankumar.7200384@gmail.com"
                    className="bg-portfolio-dark-blue hover:bg-portfolio-blue transition-colors p-2 rounded-full"
                  >
                    <Mail size={24} />
                  </a>
            ...
            <div className="md:col-span-7 project-card">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button 
                  type="submit" 
                  className="bg-portfolio-blue hover:bg-portfolio-light-blue text-white px-6 py-3 rounded-md transition-colors duration-300"
                >
                  Send Message
                </button>
              </form>
