          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mt-10">
            ...
            <div className="md:col-span-7 project-card">
              ...
              <p className="text-gray-300 mb-4">
                A Tech-driven Computer Science Engineering student with hands-on experience in full-stack web development 
                and deep learning. Proficient in Python, Java, HTML, CSS, JavaScript, and frameworks like React. 
                Strong understanding of SDLC, Agile methodologies, debugging, and testing.
              </p>
              <p className="text-gray-300 mb-6">
                Passionate about building innovative, scalable, and user-friendly applications. 
